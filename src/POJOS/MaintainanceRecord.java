...
public class MaintainanceRecord implements Serializable{
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(maintainanceId, that.maintainanceId) && Objects.equals(maintainanceDate, that.maintainanceDate) ;
        //&& Objects.equals(description, that.description)
    }

    @Override
    public int hashCode() {
        return Objects.hash(maintainanceId, maintainanceDate);
        //, description
    }
}
